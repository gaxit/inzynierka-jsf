 ...
 * 
 */
@WebServiceClient(name = "userService", targetNamespace = "users", wsdlLocation = "http://localhost:6666/users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("users", "userService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6666/users?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("users", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("users", "UserServicePort"), UserService.class, features);
    }
